...
if __name__=="__main__":
  ...
  if mode =='train':
      state = torch.load(model_path+"tetris_best_124925.dat", map_location=lambda stg,_: stg)# FIRST ONE 348 + 10702 
      ...
      state = torch.load(model_path+"tetris_best_124925.dat", map_location=lambda stg,_: stg)
      net.load_state_dict(state)
      for i in range (100):
